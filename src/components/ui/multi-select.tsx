    ...
    <div ref={containerRef} className={`space-y-1 w-full text-left relative ${isOpen ? "z-50" : "z-10"} ${className}`}>
      ...
      <div className="relative">
        <button
          ...
          className={`w-full text-left bg-zinc-900 border rounded-lg py-2.5 px-4 pr-10 text-sm focus:outline-none transition-colors font-light cursor-pointer flex items-center justify-between min-h-[42px] ${
            isOpen ? "border-brand" : "border-zinc-800"
